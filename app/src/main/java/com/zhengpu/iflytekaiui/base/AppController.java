...
public class AppController {
    ...
    public static final String RADIO = "radio";// 广播电台
    public static final String STOCK = "stock";// 股票
    public static final String TRANSLATION = "translation";// 股票
    public static final String DRAMA = "drama";// 戏曲
    public static final String HOTELSEARCH = "hotelSearch";// 酒店搜索
   ...
   //  发送给机器人基本指令
    ...
    public static final byte[] byteHeadUp =new byte[]{0x5A,0x50,0x05,0x02,0x01,0x02,0x00,0x00,0x05,0x0D,0x0A} ; //抬头
    public static final byte[] byteHeadDown =new byte[]{0x5A,0x50,0x05,0x02,0x01,0x03,0x00,0x00,0x06,0x0D,0x0A} ; //低头
    public static final byte[] byteHeadReset =new byte[]{0x5A,0x50,0x05,0x02,0x01,0x06,0x00,0x00,0x09,0x0D,0x0A} ; //头复位
    public static final byte[] byteHeadRight =new byte[]{0x5A,0x50,0x05,0x02,0x01,0x05,0x00,0x00,0x08,0x0D,0x0A} ; //头右转
    public static final byte[] byteHeadLeft =new byte[]{0x5A,0x50,0x05,0x02,0x01,0x04,0x00,0x00,0x07,0x0D,0x0A} ; //头左转
    public static final byte[] byteHandReset =new byte[]{0x5A,0x50,0x05,0x01,0x01,0x06,0x00,0x00,0x08,0x0D,0x0A} ; //手复位
    public static final byte[] byteDownRightHand =new byte[]{0x5A,0x50,0x05,0x01,0x01,0x05,0x00,0x00,0x07,0x0D,0x0A} ; //放右手
    public static final byte[] byteUpRightHand =new byte[]{0x5A,0x50,0x05,0x01,0x01,0x04,0x00,0x00,0x06,0x0D,0x0A} ; //抬右手
    public static final byte[] byteDownLeftHand =new byte[]{0x5A,0x50,0x05,0x01,0x01,0x03,0x00,0x00,0x05,0x0D,0x0A} ; //放左手
    public static final byte[] byteUpLeftHand =new byte[]{0x5A,0x50,0x05,0x01,0x01,0x02,0x00,0x00,0x04,0x0D,0x0A} ; //抬左手
    ...
    public static final byte[] byteMotorStop=new byte[]{0x5A,0x50,0x03,0x02,                        0x1,0x12,0x15,0x0D,0x0A} ; //机器人停止
...
//    体感触摸：
    ...
    public static final  String DownRightHand ="放右手";
    public static final  String DownLeftHand ="放左手";
    public static final  String UpRightHand ="抬右手";
    public static final  String UpLeftHand ="抬左手";
