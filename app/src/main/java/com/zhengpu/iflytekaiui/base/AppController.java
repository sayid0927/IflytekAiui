...
public class AppController {
   ...
   //  发送给机器人基本指令
    ...
    public static final byte[] byteHeadLeft =new byte[]{0x5A,0x50,0x03,0x02,                        0x1,0x10,0x13,0x0D,0x0A} ; //头左转
    public static final byte[] byteHeadRight =new byte[]{0x5A,0x50,0x03,0x02,                       0x1,0x11,0x14,0x0D,0x0A} ; //头右转
